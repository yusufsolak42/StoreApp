        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "/images/2.jpg", 9000m, "Keyboard", false, "" },
                    { 3, 2, "/images/3.jpg", 3000m, "Monitor", false, "" },
                    { 4, 2, "/images/4.jpg", 4000m, "Mouse", false, "" },
                    { 5, 2, "/images/5.jpg", 1000m, "Deck", false, "" },
                    { 6, 1, "/images/6.jpg", 400m, "Harry Potter", false, "" },
                    { 7, 1, "/images/7.jpg", 250m, "Actualized", false, "" },
                    { 8, 1, "/images/8.jpg", 550m, "VR glasses", true, "" },
                    { 9, 2, "/images/9.jpg", 7800m, "Reality Key", true, "" },
                    { 10, 1, "/images/10.jpg", 9000m, "Battery X", true, "" }
                });
